...
\title{Get started writing an LSST DESC Note or paper quickly with \texttt{start\_paper}}

\maketitlepre

\begin{abstract}

In this Note we describe the \texttt{start\_paper} package, and how it supports rapid creation and evolution of LSST DESC Notes or papers.
