...
We describe the \code{start\_paper} project, including the
cookiecutter mechanism and various paper and LSST DESC Note templates.
A PDF version of the paper is compiled at travis-ci every time the GitHub repo is updated, with the output being deployed either to a remote ``pdf'' or ``drafts'' branch.
